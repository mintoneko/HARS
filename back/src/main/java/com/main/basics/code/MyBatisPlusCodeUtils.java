package com.main.basics.code;

import cn.hutool.core.date.DateUtil;
import com.main.basics.code.bean.Entity;
...
public class MyBatisPlusCodeUtils {
    ...
    private static final String author = "mobai";
    ...
    private static final String entityPackage = "com.main.test.entity";

    @ApiModelProperty(value = "dao对应包")
    private static final String daoPackage = "com.main.test.mapper";

    @ApiModelProperty(value = "service对应包")
    private static final String servicePackage = "com.main.test.service";

    @ApiModelProperty(value = "serviceImpl对应包")
    private static final String serviceImplPackage = "com.main.test.serviceimpl";

    @ApiModelProperty(value = "controller对应包")
    private static final String controllerPackage = "com.main.test.controller";
